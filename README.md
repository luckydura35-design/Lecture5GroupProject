Ниже — **полный `README.md`**, уже оформленный в **GitHub-markdown**, который можно **сразу копировать и заливать в репозиторий**.
Первая итерация сохранена, вторая — логично добавлена ниже.
